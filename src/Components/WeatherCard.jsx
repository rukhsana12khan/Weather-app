...
const WeatherCard = ({
  ...
  return (
    <div className='w-[22rem] min-w-[22rem] h-[35rem] glassCard p-4 text-black mt-[15%]'>
      ...
      <div className='w-full flex justify-between items-center mt-4 gap-4 '>
        <p className='flex-1 text-center p-2 font-bold bg-[#ffff4d] shadow rounded-lg'>
          Wind Speed
          <p className='font-normal'>
            {windspeed} km/h
          </p>
        </p>
        <p className='flex-1 text-center p-2 font-bold rounded-lg bg-[#1aa3ff]'>
